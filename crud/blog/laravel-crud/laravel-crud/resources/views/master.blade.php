...
<nav class="navbar navbar-expand-md bg-light navbar-light shadow">
    <div class="container">
        <div class="navbar-brand">
            <a href="" class="text-decoration-none"> <i>PDNCRUD</i> </a>
        </div>
        <ul class="navbar-nav">
            ...
            <li><a href="{{route('product.add')}}" class="nav-link">Product Add </a></li>
            <li><a href="{{route('product.mange')}}" class="nav-link">Product Manage </a></li>
